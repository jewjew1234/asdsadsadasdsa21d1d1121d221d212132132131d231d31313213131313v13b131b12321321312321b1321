--[[
    Standalone UI Library – Fixed & Restyled
    - Safe Library:Create (handles non‑table properties)
    - Uses FontFace for custom fonts (no “unable to cast font”)
    - Dark “digital framework” look (colors, gradients)
    - Full API: AddTab, AddGroupbox, AddToggle, AddSlider, AddDropdown, AddKeyPicker, AddColorPicker, etc.
]]
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        -- Full ColorPicker implementation
        -- (same as in the fixed library – included for completeness)
...
function Library:CreateWindow(...)
    ...
    Library:GiveSignal(InputService.InputBegan:Connect(function(Input, Processed)
        ...
        elseif Input.KeyCode == Enum.KeyCode.End or (Input.KeyCode == Enum.KeyCode.RightShift and (not Processed)) then
            task.spawn(Library.Toggle)
        end
    end))
